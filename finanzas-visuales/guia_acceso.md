...
3. **Importar Proyecto**: En el dashboard de Vercel, pulsa "Add New..." -> "Project". Selecciona tu repositorio `finanzas-visuales` y dale a **Deploy**.
4. ¡Listo! Vercel te proporcionará una URL pública (ejemplo: `https://finanzas-visuales.vercel.app`).
