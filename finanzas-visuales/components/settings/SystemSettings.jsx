...
import { Card, CardHeader, CardTitle, CardContent, Button, Input, useToast, ConfirmDialog } from '@/components/ui/UI'
        ...
        <div className="space-y-6">
            <Card className="border-slate-800 bg-slate-900/50">
                ...
                <CardContent className="space-y-6">
                    <div className="space-y-2">
                        ...
                        <p className="text-sm text-slate-400">{t('export_desc')}</p>
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="grid gap-2">
                            <input type="file" accept=".xlsx, .xls" onChange={handleImport} className="hidden" id="import-file" />
                            <label htmlFor="import-file">
                                <Button asChild variant="outline" className="w-full border-slate-700 hover:bg-slate-800 text-slate-300 cursor-pointer">
                                    <span>
            ...
            <Card className="border-red-900/50 bg-red-950/10">
                ...
                <CardContent className="space-y-4">
                    <p className="text-sm text-slate-400">{t('danger_desc')}</p>
                    <Button
                        variant="destructive"
                        onClick={handleReset}
