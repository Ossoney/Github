...
def trunc_to_float(num_f,f_dec):
...
mess_txt =('El número introducido por el usuario es:')
print_msg(mess_txt, my_num)

mess_txt =('¿Cuántos decimales? ')
factor = input_usr(mess_txt)

mess_txt =('El usuario quiere el número con n decimales:')
print_msg(mess_txt, factor)

factor_str = convert_to_str(factor)

mess_txt= ('El factor de multiplicación en string es: ')
...
res_float_t = (trunc_to_float(res_float,factor_mult))
