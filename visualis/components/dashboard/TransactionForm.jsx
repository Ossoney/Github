                                                ...
                                                {rootCategories.map(cat => {
                                                    ...
                                                    return (
                                                        ...
                                                        >
                                                            ...
                                                            <span className="text-xs text-slate-400 w-full text-center whitespace-normal line-clamp-2 leading-tight h-8 flex items-center justify-center">{tCategory(cat.name)}</span>
                                                        </button>
                                                    )
                                                })}
                                            </div>
                                                ...
                                                <div className="grid grid-cols-3 gap-2">
                                                    {subCategories.map(cat => (
                                                        <button
                                                            ...
                                                            className="p-1.5 rounded-lg bg-slate-800/50 hover:bg-slate-800 text-[11px] text-slate-300 border border-slate-700/50 whitespace-normal break-words line-clamp-2 h-auto min-h-[38px] flex items-center justify-center text-center leading-tight"
                                                        >
                                                            {tCategory(cat.name)}
                                                        </button>
                                                    ))}
