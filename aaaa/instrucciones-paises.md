...
Para **cada pais** crear una carpeta.También hay que pensar que a veces hay poetas que escriben en esa lengua y no son paises que hablen ese idioma: pueden ser excolonias o regiones, a saber...
Para **cada poeta** de ese país crear:
...
```
.md → /home/osso/Descargas/aaaa/pais/poetas_idioma
```
...
1. **Identificar** poetas fallecidos ≥1956 → **Renombrar** archivos: `poeta_NO_DERECHOS.md`
