...
- **10 poemas**: Presentados en bloques separados (NO en tabla lado a lado):
  1. **Primero**: bloque completo en ESPAÑOL (traducción al castellano)
  2. **Luego**: bloque completo en IDIOMA ORIGINAL (sólo si el original no es castellano)
  - *(Si el idioma original ya es castellano, sólo aparece el bloque en español)*
